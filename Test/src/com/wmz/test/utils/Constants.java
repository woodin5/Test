...
public class Constants {
	...
	public static String FACE_KEY = "108bcefc42e8d4ce35f60ac464944ac3";
	public static String FACE_SECRET = "HMeFjUHCLDofBLsrL3MetVsrP9o4lgoh";
	public static String FACE_URL = "apicn.faceplusplus.com";
}
